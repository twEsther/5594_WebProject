...
<!-- **************************** -->
	...
	<div style="float:right;width:90%;background-color:#646462;">
		...
		<div id="root_mainView" class="root_mainView" style="background-color:##d8d8d7;">
			...
			<div class="info">
				<div class="infoimg">
					<img class="infoIMG" src="<%= request.getContextPath() %>/images/list1.png"/></div>
				
				<div class="listname">
					<h6>播放清單</h6>
					<div class="list_name">最近常聽</div>
					<div class="description">最近常聽、最近常聽、最近常聽 還有這裡是寫死的如果不能隨機抓要記得改</div>
				</div>
			</div>
<% 
	...
	if(member!=null) {
		...
		list = service.getMemberLoveList(member.getEmail(), "最近常聽");
	} 
