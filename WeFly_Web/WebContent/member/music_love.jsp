...
<!-- **************************** -->
	...
	<div style="float:right;width:90%;background-color:#646462;">
		...
		<div id="root_mainView" class="root_mainView" style="background-color:##d8d8d7;">
			...
			<div class="info">
				<div class="infoimg">
					<img class="infoIMG" src="<%= request.getContextPath() %>/images/liked-songs-300.png"/></div>
				
				<div class="listname">
					<h6>播放清單</h6>
					<div class="list_name">已按讚的歌曲</div>
					<div class="description">Billie Eilish、Liam Payne 還有這裡是寫死的如果不能隨機抓要記得改</div>
				</div>
			</div>
<% 
	...
	if(member!=null) {
		...
		list = service.getMemberLoveList(member.getEmail(), "按讚");
	} 
			...
			<table id="mainplaylist" style='border-bottom:1px solid #bababa'>
				<tbody>
					<tr class="playlist_container">
						...
						<td class="addtolist"><input type="submit" name="love" value="加到歌單"></td>
						<td class="share"><input type="submit" name="love" value="收回讚"></td>
					<%  %>
					</tr>
				</tbody>
			</table>
